...
export const SHOW_FOOTER_ROUTES = [
  ...
  ROUTES.BLOGS,
  ROUTES.LOGIN.HOME,
  ROUTES.LOGIN.PERSONAL_LOAN,
  ROUTES.LOGIN.DEBT_CONSOLIDATION,
  ROUTES.LOGIN.OVERDRAFT_FACILITY,
  ROUTES.LOGIN.SHORT_TERM_LOAN,
 ...
 */
export const HIDE_SCROLL_TO_TOP_ROUTES = [
  ROUTES.EMPLOYMENT_TYPE,
  ROUTES.PERSONAL_INFORMATION,
  ROUTES.PERSONAL_LOAN_INFO_1,
  ROUTES.PERSONAL_LOAN_INFO_2,

...
const DebtConsolidationLoginPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Debt Consolidation Login:', formData);
    // Navigate to debt consolidation info page 1
    navigate('/debt-consolidation-info-1');
  };
              ...
              <div className="relative w-[617px] h-[687px]">
                ...
                <div className="absolute bottom-8 left-8 right-8 z-10">
                  <h2 className="text-5xl font-semibold leading-[110%] tracing-[-0.8%] text-white">
                    ...
                    One Loan, One EMI <span className="text-brand">›</span>
                  </h2>
                </div>
              </div>
            </div>
...
export default DebtConsolidationLoginPage;

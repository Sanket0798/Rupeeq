            ...
            <form onSubmit={handleSubmit} className="">
              ...
              <div className='mt-8'>
                <button
                  ...
                  className="bg-custom-purple hover:bg-custom-purple-dark text-white font-bold py-[14px] px-[57px] rounded-full transition-all duration-300 text-lg leading-[110%] tracing-[-0.2px] cursor-pointer"
                >
                  Sign In
                </button>
              </div>

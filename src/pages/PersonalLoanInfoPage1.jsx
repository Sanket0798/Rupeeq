...
const PersonalLoanInfoPage1 = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Personal Loan Info 1:', formData);
    // Navigate to next page
    navigate('/personal-loan-info-2');
  };
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1232px] flex flex-row gap-[79px] my-[76px]">
        ...
        <div className="relative">
          <div
            className="rounded-3xl w-[552px] p-14 overflow-hidden border-2 border-custom-purple shadow-[5px_4px_4px_0px_rgba(0,0,0,0.25)]"
            style={{
...
export default PersonalLoanInfoPage1;

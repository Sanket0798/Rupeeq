...
const OverdraftFacilityInfoPage1 = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Overdraft Facility Info 1:', formData);
    // Navigate to next page
    navigate('/overdraft-facility-info-2');
  };
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1232px] flex flex-row items-center gap-[79px] my-[76px]">
        ...
        <div className="relative">
          <div
            className="rounded-3xl w-[552px] p-14 overflow-hidden border-2 border-custom-purple shadow-[5px_4px_4px_0px_rgba(0,0,0,0.25)] bg-gradient-to-b from-[#F9AAA6]/30 to-white"
          >
            {/* Logo */}
...
export default OverdraftFacilityInfoPage1;

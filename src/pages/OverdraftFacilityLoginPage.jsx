...
const OverdraftFacilityLoginPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Overdraft Facility Login:', formData);
    // Navigate to overdraft facility info page 1
    navigate('/overdraft-facility-info-1');
  };
              ...
              <div className="relative w-[617px] h-[687px]">
                ...
                <div className="absolute bottom-8 left-8 right-8 z-10">
                  <h2 className="text-5xl font-semibold leading-[110%] tracing-[-0.8%] text-white">
                    ...
                    Pay Only What You Use <span className="text-brand">›</span>
                  </h2>
                </div>
              </div>
            </div>
...
export default OverdraftFacilityLoginPage;

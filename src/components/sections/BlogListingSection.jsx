        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-[47px]">
          ...
          <div className="lg:col-span-1">
            <div className="lg:sticky lg:top-24 ">
              ...
              {/* Credit Score Widget */}
              <div className="bg-[#E5FBF5] text-center rounded-[10px] shadow-[4px_4px_4px_rgba(0,0,0,0.25)] px-6 md:px-[45px] pb-8 md:pb-[53px] mt-16 md:mt-24">
              ...
              <div className="bg-tranparent rounded-b-[20px] mt-6 md:mt-8 lg:mt-[66px]">
